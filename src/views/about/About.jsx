            ...
            <div className='about-container'>
                ...
                <div className='about-list'>
                    ...
                    <div className='dev-bio'>
                        <a className='social-links' href="https://github.com/satyadvaya">github</a>
                        <a className='social-links' href="https://www.linkedin.com/in/alan-willoughby/">linked in</a>
                        <a className='social-links' href="mailto:satyadvaya@gmail.com?subject=Inquiry" >Email me</a>
                    </div>
                    </section>
